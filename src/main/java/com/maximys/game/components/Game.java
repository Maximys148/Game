...
public class Game {
    ...
    // TODO Сделать так чтобы ходил один бот и это показывалось на фронте, чтобы он прошёл, собрал всю еду
    //  и сервер написал об окончании игры и бот сам выходит с сервака когда узнаёт от него что игра закончена
    //  поменять генерацию карты и обрабатывать ошибки от disconnect()
